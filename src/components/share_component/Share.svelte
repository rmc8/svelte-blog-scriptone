...
<style lang="postcss">	.share-icons-container {
	...
	.share-icon-wrapper {
		@apply w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-full bg-[--accent-color-light] hover:bg-[--accent-color-dark] transition-all duration-300 ease-in-out;
	}
	.share-icon {
